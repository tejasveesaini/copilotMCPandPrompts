...
1. **Feature PRD**: @exampleDocs/{feature-name}.md

## Output Format

Create comprehensive test planning documentation:

1. **Test Strategy**: @exampleDocs/{feature-name}/test-strategy.md
2. **Test Issues Checklist**: @exampleDocs/{feature-name}/test-issues-checklist.md
3. **Quality Assurance Plan**: @exampleDocs/{feature-name}/qa-plan.md
